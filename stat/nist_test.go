...
func testNist() {
	...
	numacc1 := Float64Slice{10000001, 10000003, 10000002}

	numacc2 := make(Float64Slice, 1001)

	numacc3 := make(Float64Slice, 1001)

	numacc4 := make(Float64Slice, 1001)
...

	{
		...
		gsl_test_rel(mean, expected_mean, 1e-15, "lottery gsl_stat_mean")
		gsl_test_rel(sd, expected_sd, 1e-15, "lottery gsl_stat_sd")
...

	{
		...
		gsl_test_rel(mean, expected_mean, 1e-15, "mavro gsl_stat_mean")
		gsl_test_rel(sd, expected_sd, 1e-13, "mavro gsl_stat_sd")
...

	{
		...
		gsl_test_rel(mean, expected_mean, 1e-15, "michelson gsl_stat_mean")
		gsl_test_rel(sd, expected_sd, 1e-13, "michelson gsl_stat_sd")
...

	{
		...
		gsl_test_rel(mean, expected_mean, 1e-14, "pidigits gsl_stat_mean")
		gsl_test_rel(sd, expected_sd, 1e-15, "pidigits gsl_stat_sd")
...

	{
		...
		gsl_test_rel(mean, expected_mean, 1e-15, "acc1 gsl_stat_mean")
		gsl_test_rel(sd, expected_sd, 1e-15, "acc1 gsl_stat_sd")
...

	{
		...
		gsl_test_rel(mean, expected_mean, 1e-15, "acc2 gsl_stat_mean")
		gsl_test_rel(sd, expected_sd, 1e-15, "acc2 gsl_stat_sd")
...

	{
		...
		gsl_test_rel(mean, expected_mean, 1e-15, "acc3 gsl_stat_mean")
		gsl_test_rel(sd, expected_sd, 1e-9, "acc3 gsl_stat_sd")
...

	{
		...
		gsl_test_rel(mean, expected_mean, 1e-15, "acc4 gsl_stat_mean")
		gsl_test_rel(sd, expected_sd, 1e-7, "acc4 gsl_stat_sd")
